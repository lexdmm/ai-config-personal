# Catálogo detalhado de critérios universais de aceite técnico

Fonte: consolidado a partir de `PROMPT-MASTER-COMPLETO.md`, `PROMPT-GOLANG.md`,
`PROMPT-PHP-LARAVEL.md` e `PROMPT-TYPESCRIPT-REACT-NESTJS.md`. Os critérios
comuns permanecem neste arquivo; critérios exclusivos ficam nos arquivos de
cada stack para evitar repetição e aplicação fora de contexto.
